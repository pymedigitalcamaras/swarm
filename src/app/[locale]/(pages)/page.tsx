...
export default function HomePage() {
  ...
  const stats = [
    { icon: Factory, value: "20+", label: t("yearsExperience") },
  ...
  const solarBenefits = [
    {
      icon: Zap,
      title: t("solarBenefit1Title"),
      desc: t("solarBenefit1Desc"),
    },
    {
      icon: Sun,
      title: t("solarBenefit2Title"),
      desc: t("solarBenefit2Desc"),
    },
    {
      icon: TrendingDown,
      title: t("solarBenefit3Title"),
      desc: t("solarBenefit3Desc"),
    },
  ];
            ...
            <div className="animate-fade-in-up">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Button
                  asChild
                  size="lg"
                  className="bg-[#F59E0B] hover:bg-[#D97706] text-white font-bold px-8 py-6 text-lg rounded-xl transition-all hover:scale-105 animate-pulse-glow"
                >
                ...
                <Button
                  ...
                  size="lg"
                  variant="outline"
                  className="border-white/30 text-white hover:bg-white/10 hover:border-white/50 px-8 py-6 text-lg rounded-xl transition-all"
                >
                ...
                <div className="relative bg-white/10 backdrop-blur-sm rounded-3xl p-6 border border-white/20">
                  ...
                  <div className="mt-4 flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-white/60 text-sm">17,8 kW | 5.000 L/día</p>
                    </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {benefits.map((benefit, i) => (
              <div
                key={i}
                className="reveal bg-white rounded-2xl p-6 shadow-lg hover-lift border border-gray-100"
                ...
                {[
                  ...
                  <div key={i} className={`rounded-xl p-6 border-2 ${system.color}`}>
                    ...
                    <div className="space-y-2 text-sm">
                      ...
                      <div className="flex justify-between">
                        <span className="text-gray-600">{t("efficiencyLabel")}</span>
                        <span className="font-semibold">{system.efficiency}</span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-gray-600">{t("solarLabel")}</span>
                        <span className="font-semibold">{system.solar}</span>
                      </div>
                    </div>
                  </div>
                ))}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            {filteredProducts.map((product, i) => (
              <div
                key={product.id}
                className="reveal bg-white rounded-2xl border border-gray-100 shadow-md hover-lift overflow-hidden group"
              ...
              >
                ...
                <div className="p-5">
                  ...
                  <h3 className="font-bold text-[#1E3A5F] text-sm mb-2 line-clamp-2">
                  ...
                  <Button
                    ...
                    className="w-full bg-[#1E3A5F] hover:bg-[#142840] text-white text-sm"
                  >
                    {t("viewDetails")}
                  </Button>
                </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {tools.map((tool, i) => (
              <div
                key={i}
                className="reveal bg-white rounded-2xl p-6 shadow-lg hover-lift border border-gray-100 text-center"
                style={{ transitionDelay: `${i * 0.1}s` }}
              >
          ...
          <div className="mt-12 text-center reveal">
            <div className="bg-[#1E3A5F] rounded-2xl p-8 text-white max-w-3xl mx-auto">
              ...
              <Button
                asChild
                className="bg-[#F59E0B] hover:bg-[#D97706] text-white font-bold px-8 py-4 text-lg rounded-xl"
              >
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <a href="mailto:prosol.aguacaliente@gmail.com" className="text-gray-600 text-sm hover:text-[#1E3A5F]">
            ...
            <div className="reveal">
              <div className="bg-[#F8FAFC] rounded-2xl p-8 border border-gray-100">
                ...
                <form className="space-y-4">
                  ...
                  />
                  <Button className="w-full bg-[#1E3A5F] hover:bg-[#142840] text-white font-bold py-3 rounded-xl">
                    {t("formSubmit")}
                  </Button>
                </form>
              </div>
      ...
      {selectedProduct && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm" onClick={() => setSelectedProduct(null)}>
          <div className="bg-white rounded-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto shadow-2xl" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="p-6">
              <div className="text-sm text-[#1E3A5F]/70 font-medium mb-1">
              ...
              <div className="grid grid-cols-2 gap-4 mb-6">
                <div className="bg-gray-50 rounded-lg p-3">
                  <div className="text-xs text-gray-500">{t("modalPower")}</div>
                  <div className="font-bold text-[#1E3A5F]">{selectedProduct.power} kW</div>
                </div>
                <div className="bg-gray-50 rounded-lg p-3">
                  <div className="text-xs text-gray-500">{t("modalTemp")}</div>
                  <div className="font-bold text-[#1E3A5F]">{selectedProduct.temperature}°C</div>
                </div>
                <div className="bg-gray-50 rounded-lg p-3">
                  <div className="text-xs text-gray-500">{t("modalFlow")}</div>
                  <div className="font-bold text-[#1E3A5F]">{selectedProduct.flowRate} {selectedProduct.category === "pool" ? "m³/h" : "L/h"}</div>
                </div>
                <div className="bg-gray-50 rounded-lg p-3">
                  <div className="text-xs text-gray-500">{t("modalVoltage")}</div>
                  <div className="font-bold text-[#1E3A5F]">{selectedProduct.voltage}</div>
                </div>
                <div className="bg-gray-50 rounded-lg p-3">
                  <div className="text-xs text-gray-500">{t("modalRefrigerant")}</div>
                  <div className="font-bold text-[#1E3A5F]">{selectedProduct.refrigerant}</div>
                </div>
                <div className="bg-gray-50 rounded-lg p-3">
                  <div className="text-xs text-gray-500">{t("modalWeight")}</div>
                  <div className="font-bold text-[#1E3A5F]">{selectedProduct.weight} kg</div>
                </div>
              </div>
              ...
              <div className="mb-6">
                ...
                <div className="flex flex-wrap gap-2">
                  {selectedProduct.applications.map((app, i) => (
                    <span key={i} className="bg-[#1E3A5F]/10 text-[#1E3A5F] text-xs font-medium px-3 py-1 rounded-full">
                      {app}
                    </span>
                  ))}
                </div>
              ...
              <Button className="w-full bg-[#F59E0B] hover:bg-[#D97706] text-white font-bold py-3 rounded-xl">
                {t("modalQuote")}
              </Button>
            </div>
          </div>
